...
import Navbar from "./components/Navbar.jsx"; // Importing the Navbar component from a local file
        ...
        <div className="inline-flex h-screen w-full">
            ...
            <div className="overflow-y-auto mx-auto dark:bg-[#212121] p-3 justify-center w-screen">
                ...
                <div className="md:grid grid-cols-4 grid-flow-dense w-full gap-3 p-5">
                    ...
                    <Card cardName={"social studies and math and explanation and fantaliss"} New={1} learnt={2} due={3}/>
